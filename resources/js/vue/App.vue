<template>
    ...
    <div v-if="isLoggedIn">
        <br><router-link :to="{name:'listas_tickets'}" class="inicio">Listas de tickets</router-link>
        <br><router-link :to="{name:'registrar_tickets'}" class="inicio">Registros de tickets</router-link>
        <br><router-link :to="{name:'listas_usuarios'}" class="inicio">Listas de usuarios</router-link>
